...
describe('handlers', function (){
  ...
  describe('#post_polls', function (){
    ...
    it('should create a new poll', function (done){
      var o = { hostname: 'localhost', path: '/rest/polls', port: 8372, method: 'POST' };

      var req = http.request(o, function (res){

        res.on('data', function (){

          http.get('http://localhost:8372/rest/polls', function (res){
  ...
  describe('#get_polls_by_id', function (){
    it('should return the poll we just created with the id of 0', function (done){
      ...
      var req = http.request(o, function (res){
        ...
        res.on('data', function (){
          ...
          http.get('http://localhost:8372/rest/polls/0', function (res){
            var d = ''; res.on('data', function (c){ d += c; });
            res.on('end', function (){
    ...
    it('should return a 404 when the poll was not found', function (done){
      http.get('http://localhost:8372/rest/polls/500', function (res){
        var d = ''; res.on('data', function (c){ d += c; });
        res.on('end', function (){
          d = JSON.parse(d);
  ...
  describe('#get_results_by_id', function (){
    ...
    it('should get the poll results for the poll we just created with the id of 0', function (done){
      ...
      var req = http.request(o, function (res){
        ...
        res.on('data', function (){
          ...
          http.get('http://localhost:8372/rest/results/0', function (res){
            var d = ''; res.on('data', function (c){ d += c; });
            res.on('end', function (){
    ...
    it('should return a 404 when the poll is not found', function (done){
      ...
      http.get('http://localhost:8372/rest/results/500', function (res){
        var d = ''; res.on('data', function (c){ d += c; });
        res.on('end', function (){
          d = JSON.parse(d);
  ...
  describe('#post_vote_by_id', function (){
    ...
    it('should increment the vote for options 1 (not 0) to 1', function (done){
      var o = { hostname: 'localhost', path: '/rest/vote/0', port: 8372, method: 'POST' };
    ...
    it('should allow multiple votes when we set ip:true', function (done){
      ...
      var req = http.request(o, function (res){
        ...
        res.on('end', function (){
          ...
          var o = { hostname: 'localhost', path: '/rest/vote/' + id, port: 8372, method: 'POST' };
            ...
            res.on('end', function (){
              ...
              var req = http.request(o, function (res){
                ...
                res.on('end', function (){
                  ...
                  http.get('http://localhost:8372/rest/results/' + id, function (res){
                    var d = ''; res.on('data', function (c){ d += c; });
                    res.on('end', function (){
    ...
    it('should return a 404 when the poll is not found', function (done){
      var o = { hostname: 'localhost', path: '/rest/vote/500', port: 8372, method: 'POST' };
